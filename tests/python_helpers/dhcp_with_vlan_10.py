...
def update_DHCP(interface,servers_ip_address,clients_new_ip_address,clients_mac_address, vlan_id):
...
def dhcp_handling():
    ...
    update_DHCP(interface,servers_ip_address,clients_new_ip_address,clients_mac_address, vlan_id=10)
